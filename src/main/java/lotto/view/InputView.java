...
public final class InputView {
    ...
    private static final String WINNING_NUMBER_IS_NOT_INTEGER = "입력된 당첨 번호가 숫자가 아닙니다: %s";
    ...
    private static Integer parseToInteger(String s) {
        try {
            ...
            throw new IllegalArgumentException(String.format(WINNING_NUMBER_IS_NOT_INTEGER, s), e);
        }
    }
}
