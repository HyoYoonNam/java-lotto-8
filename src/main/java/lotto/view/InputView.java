...
public final class InputView {
    private static final String READ_REGULAR_NUMBERS_PROMPT = "당첨 번호를 입력해 주세요.";
     ...
     */
    public static List<Integer> readRegularNumbers() {
        System.out.println(READ_REGULAR_NUMBERS_PROMPT);
